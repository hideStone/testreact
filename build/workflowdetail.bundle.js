...
var tool = {
  ...
  */
	forIos: function forIos(fnName, options) {
		if (options) {
  ...
  * @param {string} msg 
  */
	forAndroid: function forAndroid(fnName, msg) {
		if (msg) {
  ...
  * 判断手机系统
  */
	judgeMobileSystem: function judgeMobileSystem() {
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(9),B=__webpack_require__(4),C=__webpack_require__(2),ba=__webpack_require__(8),da=__webpack_require__(12),ea=__webpack_require__(13),fa=__webpack_require__(10),ia=__webpack_require__(11),D=__webpack_require__(3);
...
var WorkFlowDetail = function (_React$Component) {
    _inherits(WorkFlowDetail, _React$Component);

    function WorkFlowDetail(props) {
        _classCallCheck(this, WorkFlowDetail);
...
_reactDom2.default.render(_react2.default.createElement(WorkFlowDetail, null), document.getElementById('view-main'));
